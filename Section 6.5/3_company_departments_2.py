...
new_staff = defaultdict(set)

for department, staff in sorted(staff_broken):
    new_staff[department].add(staff)

for department in new_staff:
    print(f'{department}: {", ".join(sorted(new_staff[department]))}')
